...
public final class RetrofitClient {
     ...
     */
    public static RetrofitClient init(Application application, @NonNull RetrofitConfig defaultConfig) {
        if (instance == null) {
    ...
    /**
     * 设置请求成功的code，请求code 不同接口，可能不同
     *
     * @param successCode
     * @return -
     */
    public RetrofitClient setRequestSuccessCode(int successCode) {
        ErrorHelper.SUCCESS = successCode;
        return this;
    }
